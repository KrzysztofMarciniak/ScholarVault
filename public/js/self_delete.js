...
/**
 * Render deactivate account form
 */
export function renderDeleteSelf(onSuccess = () => {}) {
  ...
  header.className = "flex items-center gap-2 mb-4 text-red-600 dark:text-red-400 text-xl font-semibold";
  header.innerHTML = `
  ...
  warning.innerHTML = `
    ...
    <div>
      <p class="font-medium">Deactivate your account</p>
